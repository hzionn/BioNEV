...
class GCNModelAE(Model):
    def __init__(
        self, placeholders, num_features, features_nonzero, hidden1, hidden2, **kwargs
    ):
    ...
    def _build(self):
        ...
        self.reconstructions = InnerProductDecoder(
            input_dim=self.hidden_dim_2, act=lambda x: x, logging=self.logging
        )(self.embeddings)
...
class GCNModelVAE(Model):
    ...
    def _build(self):
        ...
        self.z = self.z_mean + tf.random_normal(
            [self.n_samples, self.hidden_dim_2]
